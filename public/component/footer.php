<footer class="main-footer-menu main-nav py-5 text-white bg-dark">
    <div class="container">
        <div class="row">
            <!-- Logo dan Deskripsi -->
            <div class="col-lg-3 mb-4">
                <div class="mb-3">
                    <a href="home.php" class="main-logo-footer text-white text-decoration-none">
                        <h1 class="fw-bold">BEBAS <span class="text-success">SAMPAH</span></h1>
                    </a>
                </div>
                <p class="small">Kami peduli dengan kebersihan lingkungan dan memberikan solusi terbaik untuk pengelolaan sampah. Bersama kita bisa!</p>
