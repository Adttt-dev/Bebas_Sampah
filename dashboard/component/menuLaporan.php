                        ...
                        <tr>
                            ...
                            <td class="report-actions">
                                <button class="btn btn-warning btn-sm">
                                    <a href="../page/update.php?id=<?= $l['id'] ?>" class="text-dark"><i class="bi bi-pencil me-1"></i>Edit</a>
                                </button>
                                <button class="btn btn-danger btn-sm">
                                    <i class="bi bi-trash me-1"></i>
                                    <a href="../component/deleteLaporan.php?id=<?= $l['id'] ?>" onclick="return confirm('Apakah Anda yakin?')">Delete</a>
                                </button>
                            </td>
                        </tr>
                        <?php $i++; ?>
